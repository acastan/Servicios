Postinstalación de un servidor Linux
====================================

Como distribución de Linux para servidores escoge una que sea muy estable y que proporcione actualizaciones de seguridad durante tres años o más. En este manual yo utilizaré Debian Stable 13 y Ubuntu Server 26.04.
...
------
  ...
  - [Configuración de red](#configuraci-n-de-red)
  - [Orígenes del software](#or-genes-del-software)
  - [Actualizar el software](#actualizar-el-software)
  - [Instalar nuevo software](#instalar-nuevo-software)
  - [Cambiar el arranque](#cambiar-el-arranque)
  - [Activar acceso remoto](#activar-acceso-remoto)
  - [Activar cuotas de disco](#activar-cuotas-de-disco)
  - [Instalar un escritorio](#instalar-un-escritorio)
  - [Instalar compilador](#instalar-compilador)
  - [Administración remota vía navegador](#administraci-n-remota-v-a-navegador)
...
1. En caso de trabajar con Debian edita el siguiente fichero:
...
2. En caso de trabajar con Ubuntu Server 18.04 o superiores, edita el siguiente fichero:
...
Y para cambiar la opción de arranque por defecto, edita en el fichero de configuración de GRUB la opción `GRUB_DEFAULT`, que indica la línea por defecto en el menú de arranque, teniendo en cuenta que la primera línea es la 0:
...
Vamos a instalar un servidor de SSH para poder acceder a nuestro ordenador remotamente desde otros equipos:
...
Administración remota vía navegador
-----------------------------------
