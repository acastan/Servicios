...
03. Una dirección de clase C utiliza:
    - [ ]  24 bits para la dirección de red y 8 bits para la dirección del equipo.
...
07. ¿Para qué se utiliza el protocolo ARP en una red Ethernet?
    - [ ]  Obtiene la dirección MAC de un nodo a partir de su dirección IP.
...
14. Un equipo que envío información mediante TCP, ¿cómo sabe que la información llegó?
    - [ ]  Porque recibe una señal ACK del receptor de la información.
...
15. Las tres partes de una conexión TCP son:
    ...
    - [ ]  Establecimiento de sesión, transferencia de datos, terminación de la sesión.
...
17. Cuando un cliente intenta una conexión y el servidor responde con las señales RST/ACK significa:
    ...
    - [ ]  El servidor tiene cerrado el puerto TCP donde se intenta establecer la conexión.
...
18. Un servidor DNS:
    ...
    - [ ]  Puede asociar direcciones IP a nombres de equipos y nombres de equipos a direcciones IP.
...
21. El puerto de un servicio es un número:
    ...
    - [ ]  Número bien conocido, y no suele cambiar.
...
23. ¿Qué hace un router?
    ...
    - [ ]  Intenta llevar un poquito más cerca de su destino cada paquete IP que recibe.
